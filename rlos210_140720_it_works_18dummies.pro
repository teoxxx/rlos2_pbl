...
;130820 test for darkened filtered cells!
print, max(dummy1_4d/coslosu_4d,/NaN),max(dummy1_4d)
print, coslosu_4d(1,31,45,44),where(dummy15_4d eq 123456789.),where(dummy9_4d eq 123456789.)
